...
document.addEventListener("DOMContentLoaded", () => {
  // Debug: Clear any existing auth state to ensure fresh start
...
function checkTokenExpiration() {
  // This would require decoding the JWT token to check expiration
  // For simplicity, we'll just let the API handle 401 responses
}
